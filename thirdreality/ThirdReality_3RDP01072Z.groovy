...
metadata {
    definition(
        ...
        singleThreaded: true,
        importUrl: "https://raw.githubusercontent.com/hubitrep/hubitat/refs/heads/main/thirdreality/ThirdReality_3RDP01072Z.groovy"
    ) {
        capability "Actuator"
...
private void ensureChildren() {
    ENDPOINTS.each { String ep ->
        ...
        if (existing == null) {
            ...
            DeviceWrapper cd = addChildDevice("hubitrep", CHILD_TYPE, dni,
